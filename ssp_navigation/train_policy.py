...
parser.add_argument('--hilbert-points', type=int, default=1, choices=[0, 1, 2],
                    help='how pc centers are determined. 0: random uniform. 1: hilbert curve. 2: evenly spaced grid')
